...
void add_rear(int item)
{
	...
	else
	{
		...
		printf("The Double Ended Queue after insertion of %d is,\n", item);
		display();
	}
}	
...
{	
	...
	else
	{
		...
		printf("The Double Ended Queue after deletion of %d is,\n", item);
		display();
	}
}
...
void main()
{
	...
	while(1)
	{
		...
		switch(ch)
		{
			...
			case 5:
					printf("The contents of the Double Ended Queue is,\n");
					display();
					break;
